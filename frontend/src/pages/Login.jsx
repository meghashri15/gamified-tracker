...
export default function Login() {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      // ✅ Show specific message depending on what went wrong
      const msg = err?.response?.data?.message || err?.message || ''
      if (msg.toLowerCase().includes('not found') || msg.toLowerCase().includes('no user') || msg.toLowerCase().includes('invalid email')) {
        toast.error('Account not found. Please register first.')
      } else if (msg.toLowerCase().includes('password') || msg.toLowerCase().includes('incorrect') || msg.toLowerCase().includes('invalid credentials')) {
