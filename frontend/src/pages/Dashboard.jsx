      ...
      >
        ...
        <div className="flex justify-center gap-2 mb-6">
          {TUTORIAL_STEPS.map((_, i) => (
            <div key={i}
              className={`w-2 h-2 rounded-full transition-colors ${i === step ? 'bg-purple-600' : 'bg-gray-200'}`}
            />
          ))}
        </div>
...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6 sm:py-8">
      ...
      >
        {/* On mobile the name might be long, so we let it wrap */}
      ...
      {/* Bottom widgets — stacked on mobile, 3 cols on desktop */}
